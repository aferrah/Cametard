 ...
 */
final class Version20250219161801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE camion (immat VARCHAR(10) NOT NULL, type_camion VARCHAR(20) NOT NULL, poids_transport NUMERIC(15, 2) NOT NULL, PRIMARY KEY(immat)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE marchandise (id_marchandise INT AUTO_INCREMENT NOT NULL, id_cargaison INT NOT NULL, nom VARCHAR(50) NOT NULL, type_requis VARCHAR(20) NOT NULL, poids NUMERIC(15, 2) NOT NULL, INDEX IDX_D9A871DE8D314067 (id_cargaison), PRIMARY KEY(id_marchandise)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE Cargaisons ADD CONSTRAINT FK_228289B7F0CD7A4F FOREIGN KEY (immat) REFERENCES camion (immat) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE marchandise ADD CONSTRAINT FK_D9A871DE8D314067 FOREIGN KEY (id_cargaison) REFERENCES Cargaisons (id_cargaison) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE marchandise DROP FOREIGN KEY FK_D9A871DE8D314067');
